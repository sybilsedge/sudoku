...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-200">
      <div className="blueprint-border bg-[#0e1114]/95 max-w-md w-full p-6 shadow-[0_0_40px_rgba(0,255,255,0.2)] rounded-xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between border-b border-cyan-500/25 pb-3 mb-4">
          ...
          <button
            ...
            className="p-1.5 rounded-lg border border-cyan-500/30 text-cyan-400 hover:text-cyan-100 hover:border-cyan-400 hover:shadow-[0_0_10px_rgba(0,255,255,0.3)] transition-all"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="mb-5 pb-4 border-b border-cyan-500/20">
          <div className="font-tech text-xs uppercase tracking-wider text-slate-300 mb-2">
            INTERFACE SCHEME
          </div>
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 py-2 px-3 rounded-lg font-tech text-xs uppercase tracking-wider transition-all ${
                settings.theme !== 'light'
                  ? 'bg-cyan-500/25 text-cyan-200 border border-cyan-400 shadow-[0_0_12px_rgba(0,255,255,0.3)] font-bold'
                  : 'border border-cyan-500/30 bg-black/40 text-slate-400 hover:text-cyan-300'
              }`}
            >
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              ...
              <div className="font-body text-[11px] text-slate-400">Highlight invalid numbers in red</div>
            </div>
            <button
              ...
              className={`w-12 h-6 flex items-center rounded-full p-1 border transition-all ${
                settings.autoCheckErrors
                  ? 'bg-cyan-500/30 border-cyan-400 shadow-[0_0_10px_rgba(0,255,255,0.25)]'
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              ...
              <div className="font-body text-[11px] text-slate-400">Shade intersecting coordinate vectors</div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              ...
              <div className="font-body text-[11px] text-slate-400">Illuminate identical values on grid</div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              ...
              <div className="font-body text-[11px] text-slate-400">Remove notes in row/col/box on entry</div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              ...
              <div className="font-body text-[11px] text-slate-400">Autonomously populate pencilmark vectors</div>
            </div>
            <button
        ...
        <div className="border-t border-cyan-500/25 pt-4">
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            {(['easy', 'medium', 'hard'] as const).map((diff) => {
              ...
              return (
                <div key={diff} className="blueprint-border bg-black/40 rounded-lg p-2.5 font-tech">
                  <div className="text-[11px] font-bold uppercase text-cyan-300 mb-1">{diff}</div>
                  <div className="text-[10px] text-slate-400">
                    WON: <span className="font-semibold text-slate-200">{dStats.completed}</span>/{dStats.played}
                  </div>
        ...
        <button
          onClick={onClose}
          className="mt-6 w-full py-2.5 px-4 border border-cyan-400 bg-cyan-500/20 text-cyan-200 hover:bg-cyan-500/30 hover:border-cyan-300 hover:shadow-[0_0_20px_rgba(0,255,255,0.4)] rounded-lg font-tech text-xs uppercase tracking-wider font-bold transition-all"
        >
          DONE
        </button>
      </div>
